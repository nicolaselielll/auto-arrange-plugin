...
var Applier = /*#__PURE__*/function () {
  function Applier() {
    _classCallCheck(this, Applier);
  }
  return _createClass(Applier, [{
    key: "setEditor",
...
var StandardApplier = /*#__PURE__*/function (_Applier) {
  function StandardApplier() {
    _classCallCheck(this, StandardApplier);
    return _callSuper$2(this, StandardApplier, arguments);
  }
  _inherits(StandardApplier, _Applier);
  return _createClass(StandardApplier, [{
    key: "getValidShapes",
    value: function getValidShapes(shapes) {
      return shapes.filter(function (shape) {
        var x = shape.x,
          ...
          width = shape.width,
          height = shape.height;
        return ![_typeof(x), _typeof(y), _typeof(width), _typeof(height)].includes('undefined');
      });
    }
  }, {
    key: "resizeNode",
    value: function () {
      var _resizeNode = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee(id, width, height) {
    ...
    key: "translateNode",
    value: function () {
      var _translateNode = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee2(id, x, y) {
        var view;
    ...
    key: "apply",
    value: function () {
      var _apply = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee4(nodes) {
        var _this = this;
        var offset,
          correctNodes,
          _args4 = arguments;
...
var AnimationSystem = /*#__PURE__*/function () {
  function AnimationSystem() {
    ...
    _defineProperty(this, "activeAnimations", new Map());
  }
  return _createClass(AnimationSystem, [{
    key: "start",
    ...
    key: "add",
    value: function () {
      var _add = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee(duration, id, tick) {
        var _this2 = this;
        var startTime;
        return _regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
...
var TransitionApplier = /*#__PURE__*/function (_StandardApplier) {
  ...
  function TransitionApplier(props) {
    var _this;
    _classCallCheck(this, TransitionApplier);
  ...
  _inherits(TransitionApplier, _StandardApplier);
  return _createClass(TransitionApplier, [{
    key: "applyTiming",
    ...
    key: "apply",
    value: function () {
      var _apply = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee3(nodes) {
        var _this4 = this;
        var offset,
          correctNodes,
          _args3 = arguments;
...
var AutoArrangePlugin = /*#__PURE__*/function (_Scope) {
  function AutoArrangePlugin() {
    var _this;
    _classCallCheck(this, AutoArrangePlugin);
    _this = _callSuper(this, AutoArrangePlugin, ['auto-arrange']);
    _defineProperty(_this, "elk", new ELK());
    _defineProperty(_this, "demonstration", 'https://rtsys.informatik.uni-kiel.de/elklive/json.html');
   ...
   */
  _inherits(AutoArrangePlugin, _Scope);
  return _createClass(AutoArrangePlugin, [{
    key: "addPreset",
    ...
    value: function getArea() {
      return this.parentScope(BaseAreaPlugin);
    }
  }, {
    key: "getEditor",
    value: function getEditor() {
      return this.getArea().parentScope(NodeEditor);
    }
  }, {
    ...
    value: function nodeToLayoutChild(node, context) {
      ...
      return _objectSpread(_objectSpread({
        ...
        ports: [].concat(_toConsumableArray(inputs.sort(function (a, b) {
        ...
        })), _toConsumableArray(outputs.sort(function (a, b) {
    ...
    key: "layout",
    value: (function () {
      var _layout = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee(props) {
...
export { index$2 as ArrangeAppliers, AutoArrangePlugin, index as Presets };
//# sourceMappingURL=rete-auto-arrange-plugin.esm.js.map
